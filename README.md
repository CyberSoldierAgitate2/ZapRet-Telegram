...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/CyberSoldierAgitate2/ZapRet-Telegram">CyberSoldierAgitate2/ZapRet-Telegram</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
Скачать zapret-telegram — запрет Discord (голос / RTC), обход DPI без VPN. Актуальная сборка в [Releases](https://github.com/CyberSoldierAgitate2/ZapRet-Telegram/releases/tag/1.9.9c) → 1.9.9c
[Инструкция по установке и частые вопросы](https://cybersoldieragitate2.github.io/ZapRet-Telegram/)
...
> Если вы наткнулись на что-то вне репозитория `CyberSoldierAgitate2/ZapRet-Telegram`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы релиза](https://github.com/CyberSoldierAgitate2/ZapRet-Telegram/releases/tag/1.9.9c) — `zapret-discord-youtube-1.9.9c.rar` или `zapret-discord-youtube-1.9.9c.zip`
...
Если этого не произошло, то см. [#522](https://github.com/CyberSoldierAgitate2/ZapRet-Telegram/issues/522)
...
- См. [#765](https://github.com/CyberSoldierAgitate2/ZapRet-Telegram/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/CyberSoldierAgitate2/ZapRet-Telegram/releases/tag/1.9.9c) (`zapret-discord-youtube-1.9.9c.rar` / `zapret-discord-youtube-1.9.9c.zip`)
...
- См. также [#251](https://github.com/CyberSoldierAgitate2/ZapRet-Telegram/discussions/251)
...
- См. также [#252](https://github.com/CyberSoldierAgitate2/ZapRet-Telegram/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/CyberSoldierAgitate2/ZapRet-Telegram/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/CyberSoldierAgitate2/ZapRet-Telegram/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/CyberSoldierAgitate2/ZapRet-Telegram/blob/main/LICENSE.txt)
